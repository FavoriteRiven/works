...
layui.define(["element", "jquery"], function(exports) {
	...
	Tab.prototype.navBar = function(strData) {
		...
		data = [{
				"title": "线路管理",
				"icon": "&#xe66c;",
				"href": "page/line/line.html",
				"spread": false
			}, {
				"title": "价格管理",
				"icon": "&#xe65e",
				"href": "page/price/price.html",
				"spread": false
			}]
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="page/main.html"><i class="layui-icon">&#xe66f;</i><cite>用户管理</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height() - 210);
