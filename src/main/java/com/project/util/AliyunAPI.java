...
public class AliyunAPI {
	    ...
	    private static String accessKeyId = "LTAIXwC6EDzIZf7J";
	    private static String accessKeySecret = "MQ6VFmhiKAUCZuaTphvkwL01Oxe3dA";
	    private static String signName = "禧禄软件";
	    private static String identifyingTempleteCode = "SMS_143405009";
